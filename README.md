...
- **홈화면**
  - 읽지 않은 메일이 있는 경우 헤더에 알림 아이콘이 + 로 나타납니다.
...
- **투표**
  - 질문 3개에 대한 답을 옵션 4개중에 선택할 수 있습니다.
  - 답을 모두 선택시 **투표하기** 버튼이 활성화 되며 제출할 수 있습니다.
  - 투표는 정보의 정확성을 위하여 계정당 1회 가능합니다. (중복투표 불가)
- **뮤직**
  - 새로고침 할때마다 랜덤으로 명언을 표출해줍니다.
  - 힐링 유튜브 노래 뮤비 영상을 3개 추천해줍니다.
